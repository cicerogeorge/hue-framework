...
class Inflector
{
    ...
    */
    function pluralize($word)
    {
        ...
        $uncountable = array('equipment', 'information', 'money', 'species', 'series', 'fish', 'sheep', 'meta', 'data', 'pos');
    ...
    */
    function singularize($word)
    {
        ...
        $uncountable = array('equipment', 'information', 'money', 'species', 'series', 'fish', 'sheep', 'status', 'meta', 'data', 'pos');
